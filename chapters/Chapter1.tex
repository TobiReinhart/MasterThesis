...
\end{multline}
In precisely the same way one can now construct prolongations of vector fields to higher-order jet bundles as for instance to the second-order jet bundle as it is relevant for our treatment of Lagrangian field theory:
\begin{align}
    \begin{aligned}
...
When both $E$ and $F$ are vector bundles we can also give their Whitney sum the structure of a vector bundle. The bundle $E \oplus F$ is then exactly obtained the fiber wise direct sum of $E$ and $F$.  
\end{remark}
