...
Let $M$ be an oriented 4-dimensional manifold that represents spacetime. Fields that inhabit spacetime are described as \textit{\textbf{sections}} of a bundle $(F,\pi_F,M)$, i.e., smooth maps that satisfy:
\begin{align}
\begin{aligned}
