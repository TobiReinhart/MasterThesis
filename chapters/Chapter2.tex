...
\begin{align}\label{EOMPert}
    \begin{aligned}
    E_{\text{per}}^A = \frac{\partial L_{\text{per}}}{\partial v_A} &= a^A + 2 a^{AB}H_B + 3a^{ABC}H_B H_C \\
