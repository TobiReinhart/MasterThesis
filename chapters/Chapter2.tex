...
\end{minipage}
    ...
    \label{Poly}
\end{figure}
One can now also see the underlying geometric interpretation of  hyperbolic directions  $h\in \mathbb{R}^d$ for a given polynomial $P$. If $P$ is hyperbolic w.r.t. $h$ then any affine line in direction $h$ intersects $\mathrm{deg}(P) = d$ times with the vanishing set $V(P)$.
...
\begin{align}
\begin{aligned}
    \mathcal{L}_{tot} : J^2F_{\text{grav}} \times J^1F_{\text{mat}} &\longrightarrow \Lambda^4M \\
    \mathcal{L}_{tot} &= \mathcal{L}_{\text{grav}} + \mathcal{L}_{\text{mat}}.
\end{aligned}
\end{align}
...
\begin{align}
    0 = \frac{\delta \mathcal{L}_{tot}}{\delta v_A} = \frac{\delta \mathcal{L}_{\text{grav}}}{\delta v_A} + \frac{\delta \mathcal{L}_{\text{mat}}}{\delta v_A}.
\end{align}
...
\begin{align}
    \mathrm{dim}(J^2F_{\text{GR}}) = 4 + 10 + 40 + 100 = 154,
\end{align}
